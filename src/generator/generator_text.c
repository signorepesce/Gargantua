...
char *line_trim(char *line)
{
    ...
    {
        if (isspace((unsigned char)start[len - 1u]) == 0)
        {
            break;
        }
        len--;
...
{
    assert(c_type != NULL);
    if (strlen(c_type) >= GENERATOR_MAX_NAME)
    {
        return NULL;
    }

    if (word_equals(c_type, "int") == 1)
    {
        return "FIELD_INT";
    }
    if (word_equals(c_type, "long") == 1)
    {
        return "FIELD_LONG";
    }
    if (word_equals(c_type, "double") == 1)
    {
        return "FIELD_DOUBLE";
    }
    if (word_equals(c_type, "bool") == 1)
    {
        return "FIELD_BOOL";
    }
    if (word_equals(c_type, "str") == 1)
    {
        return "FIELD_STR";
    }
    return NULL;
...
{
    assert(word != NULL);
    if (strlen(word) >= GENERATOR_MAX_NAME)
    {
        return 0;
    }

    if (word_equals(word, "$id") == 1)
    {
        return 1u;
    }
    if (word_equals(word, "$not_null") == 1)
    {
        return 2u;
    }
    if (word_equals(word, "$unique") == 1)
    {
        return 4u;
    }
    return 0u;
...
const char *http_method_from_word(const char *word)
{
    ...
    if (word_equals(word, "$get") == 1)
    {
        return "GET";
    }
    if (word_equals(word, "$post") == 1)
    {
        return "POST";
    }
    if (word_equals(word, "$put") == 1)
    {
        return "PUT";
    }
    if (word_equals(word, "$patch") == 1)
    {
        return "PATCH";
    }
    if (word_equals(word, "$delete") == 1)
    {
        return "DELETE";
    }
    return NULL;
